...
require_once '../../library/pdate.php';
			...
			$objPHPExcel = $objReader->load("../excel_templates/lab.xls");
			
	$viewid=$_GET['karvanid'];
	$today=pdate("Y-m-d");
	$sql="select code,mosque_id, visa_price, recipe_date, lab_time, laboratory from karvan where id='$viewid'";
	...
	//echo $responsibleid;
						...
						$objPHPExcel->getActiveSheet()->setCellValue('B18', $ro['laboratory']);

						
						$objPHPExcel->getActiveSheet()->setCellValue('B19', $ro['lab_time']);
			...
			header('Content-Disposition: attachment;filename="lab.xls"');
