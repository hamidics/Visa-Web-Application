...
require_once '../../library/pdate.php';
	...
	$today=pdate("Y-m-d");
	$sql="select code,mosque_id, visa_price, recipe_date from karvan where id='$viewid'";
	...
	echo $responsibleid;
						...
						$objPHPExcel->getActiveSheet()->setCellValue('A17', $ro['recipe_date']);
						$objPHPExcel->getActiveSheet()->setCellValue('D7', $row['passport_no']);
						$objPHPExcel->getActiveSheet()->setCellValue('D11', "گروهی");
						$objPHPExcel->getActiveSheet()->setCellValue('D15', $ro['visa_price']);
						...
						$objPHPExcel->getActiveSheet()->setCellValue('D19', $row3['count(id)']."نفر");
