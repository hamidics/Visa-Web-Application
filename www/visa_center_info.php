...
?>
		...
		<form method="post" action="<?php echo "visa_centers_info.php?viewid=".$_GET['viewid'];?>"  accept-charset="utf-8" id="myform"  class="formular">
			<fieldset>
				<legend align="right"><span >مشخصات اعضای مرکز ویزا</span></legend>
				رئیس شرکت :</br>
