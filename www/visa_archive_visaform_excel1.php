...
require_once '../library/pdate.php';
			...
			$objPHPExcel = $objReader->load("excel_templates/visa_form.xls");
			            ...
			            $sql3="Select * from visa_dependants where applicant_id='$_GET[visaapplicant]'";
						...
						$objPHPExcel->getActiveSheet()->setCellValue('D19', $row3['relation']);
						...
						$objPHPExcel->getActiveSheet()->setCellValue('F34', $row2['issue_date']);
						$objPHPExcel->getActiveSheet()->setCellValue('F33', $row2['visa_num']);
						...
						$objPHPExcel->getActiveSheet()->setCellValue('A26', $row1['add_in_iran']." ".$row1['phone_in_iran']);
						$objPHPExcel->getActiveSheet()->setCellValue('A27', $row1['add_in_afghanistan']." ".$row1['phone_in_afghanistan']);
						$objPHPExcel->getActiveSheet()->setCellValue('A28', $row1['job_add_in_afghanistan']." ".$row1['job_phone_in_afghanistan']);
